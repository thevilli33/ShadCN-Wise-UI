...
const CURRENCY_ACCOUNTS = [
  { code: "EUR", label: "EUR", accountId: "51568", balance: "1.00", flag: "/assets/flags/flag-eur.png" },
  { code: "AUD", label: "AUD", accountId: "30779", balance: "0.00", flag: "/assets/flags/flag-aud.png" },
  { code: "CAD", label: "CAD", accountId: "15376", balance: "0.00", flag: "/assets/flags/flag-cad.png" },
  { code: "GBP", label: "GBP", accountId: "13159", balance: "0.00", flag: "/assets/flags/flag-gbp.png" },
]
    ...
    <div className="mx-auto flex w-full max-w-[976px] flex-1 flex-col gap-14 px-6 pb-6 pt-14">
      ...
      <section className="flex gap-3 overflow-x-auto pb-1">
        {CURRENCY_ACCOUNTS.map((account) => (
          <Card key={account.code} className="w-[256px] h-[206px] shrink-0 bg-card justify-between">
